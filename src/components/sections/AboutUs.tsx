      ...
      <Container className="flex flex-col md:flex-row gap-10 lg:gap-10 items-center">
        <div className="w-full md:w-5/12 lg:w-1/2">
          <div className="w-full h-80 sm:h-96 relative">
                <img src="https://images.pexels.com/photos/8728381/pexels-photo-8728381.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="About Our Mossion"
        ...
        <div className="w-full md:w-7/12 lg:w-1/2 flex flex-col">
            ...
            <Paragraph>
                We are on a mission to empower businesses with tranformation AI
